package cn.huaxiaerp.huaxia_erp.common;
...
public class MybatisPlusGenerator {
     ...
     * <p>
     * 读取控制台内容
     address,admin,category,product,productimage,productorder,productorderitem,property,propertyvalue,review,user
     * </p>
     */
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/jsh_erp?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
        ...
        pc.setParent("cn.bdqn.sptparent");
        ...
        strategy.setTablePrefix("jsh_");   //去掉表中前缀
        //逻辑删除字段名
